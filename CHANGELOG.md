...
- **Secret indicator on pending roll buttons** — player-side pending roll buttons in the sidebar now show a small `fa-eye-slash` corner badge when the requested roll is secret
