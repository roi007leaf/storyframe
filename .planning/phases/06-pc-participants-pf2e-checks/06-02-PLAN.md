     ...
     <div class="panel-content">
       ...
       <div class="skill-request-section">
         ...
         <div class="dc-input">
           ...
           <input type="number" name="custom-dc" value="{{currentDC}}" min="1"
...
6. Implement action handlers:
   ...
   - _onRequestSkill: call_requestSkillCheck with skill slug
   - _onRequestSelectedCheck: call_requestSkillCheck for selected participants
   - _onRequestAllCheck: call_requestSkillCheck for all participants
